...
public class King extends Piece {
	 ...
	 */
	@Override
	public boolean hasLegalMove() {                         // No need to check castling, since if castling is legal, move one step toward rook should be legal too.
		return hasLegalMoveOneDirectionOneStep(0, 1)
                || hasLegalMoveOneDirectionOneStep(0, -1)
                || hasLegalMoveOneDirectionOneStep(1, 0)
                || hasLegalMoveOneDirectionOneStep(-1, 0)
                || hasLegalMoveOneDirectionOneStep(1, 1)
                || hasLegalMoveOneDirectionOneStep(1, -1)
                || hasLegalMoveOneDirectionOneStep(-1, 1)
                || hasLegalMoveOneDirectionOneStep(-1, -1);
	}
